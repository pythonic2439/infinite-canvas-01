export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            faceGuardDescription: "When enabled, video reference images sent to this provider get local eye-obscuring overlays before submission to reduce real-face moderation blocks (image edits are not guarded).",
            faceGuardTooltip: "Only the request copy is processed; canvas and asset originals stay untouched.",
            retryLimit: "Auto retry",
            retryLimitDescription: "Times a failed dola task is resubmitted automatically (0 disables). Each retry consumes quota again.",
            title: "Edit provider",
            name: "Provider name",
            protocol: "Protocol",
            ...
            paramsTitle: "Request params template ({{name}})",
            paramsPresetPlaceholder: "Pick a workflow preset",
            paramsHint: "Placeholders: {{placeholders}}. A placeholder occupying a whole JSON value keeps its raw type (number/array); empty arrays or missing items drop the field. Leave the template empty to auto-assemble params by workflow kind.",
            paramPresets: { t2v: "Text to video", flf: "First & last frame to video", images: "Multi-image to video", audio: "Multi-image + audio to video" },
