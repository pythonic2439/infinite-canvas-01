export default {
    ...
    canvas: {
        ...
        imageTools: { copyPrompt: "复制提示词", copyPromptTitle: "复制生成该图片的提示词", reversePrompt: "反推提示词", reversePromptTitle: "创建反推提示词的文本和配置节点", replace: "替换图片", locked: "锁比例", free: "自由比例", lockTitle: "切换为等比缩放", freeTitle: "切换为自由比例", mask: "局部编辑", maskTitle: "添加蒙版遮罩后局部修改", faceGuard: "眼部网格", faceGuardTitle: "本地检测人脸并在眼部叠加干扰，规避真人脸审核", crop: "裁剪", cropTitle: "裁剪并生成新节点", split: "切图", splitTitle: "按行列切分图片", upscale: "放大", upscaleTitle: "放大图片分辨率", superResolve: "超分", superResolveTitle: "AI 超分", angle: "多角度", angleTitle: "生成角度", view: "查看大图", viewTitle: "查看图片详情", more: "更多", configure: "配置快捷工具", customize: "自定义工具栏", showLabels: "显示按钮文字", description: "选择你想在图片节点编辑栏中使用的快捷工具。", preview: "节点预览", imageNode: "图片节点", quickTools: "快捷工具" },
        faceGuard: {
            title: "眼部网格（防人脸拦截）",
            hint: "在本地检测人脸并给眼部叠加干扰效果，用于规避真人脸审核。处理会在新节点上生成，原图保留。",
            detecting: "本地人脸检测中…",
            noFaces: "未检测到人脸，可调整参数或直接应用原图。",
            style: "样式",
            styles: { grid: "网格", mosaic: "马赛克", stripes: "斜条" },
            region: "范围",
            regions: { eyes: "眼部", face: "整脸" },
            density: "密度",
            opacity: "不透明度",
            margin: "扩展范围",
            apply: "应用并生成新节点",
    ...
    config: {
        ...
        channelEditor: {
            faceGuard: "防人脸拦截",
            faceGuardDescription: "开启后，发给该渠道的视频参考图会在本地给眼部叠加网格等干扰再提交，降低被真人脸审核拦截的概率（图片生图不拦截）。",
            faceGuardTooltip: "仅处理提交给模型的请求副本，画布与资产库中的原图不受影响。",
            retryLimit: "失败自动重试",
            retryLimitDescription: "dola 任务失败后自动重新提交的次数，0 为不重试；每次重试会重新消耗生成额度。",
            title: "编辑渠道",
            name: "渠道名称",
            protocol: "协议",
            baseUrl: "接口地址",
            ...
            params: "参数",
            paramsReady: "参数已设",
            paramsTitle: "请求参数模板（{{name}}）",
            paramsPresetPlaceholder: "选择工作流预设",
            paramsHint: "可用占位符：{{placeholders}}。占位符整体作为 JSON 值时保留原始类型（数字/数组），数组为空或对应项不存在时该字段自动省略；留空模板则按工作流类型自动组装参数。",
            paramPresets: { t2v: "文生视频", flf: "首尾帧生成视频", images: "多图参考生视频", audio: "多图多音频生视频" },
